...
class MyString {
private:
	static const int INCREASEHEAP = 10;
	char *data;
	int length;
	int maxlen;
...
//v1.14 2018.4.14
//	optimization:more automatic type conversion
//v1.15 2018.4.19
//	a bug in operator == overloading fixed
//v1.16 2018.6.11
//	INCREASEHEAP has been translated into a static constant integer